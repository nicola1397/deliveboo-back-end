        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item ">
                        <a class="nav-link text-white {{ str_contains(Route::currentRouteName(), 'admin.dashboard') ? 'active' : '' }} {{ str_contains(Route::currentRouteName(), 'home') ? 'active' : '' }}" aria-current="page" href="{{ Auth::check() ? route('admin.dashboard') : route('home') }}">Home</a>
                    </li>
                    @auth

                    <li class="nav-item">
                        <a class='nav-link text-white {{ str_contains(Route::currentRouteName(), 'admin.restaurants') ? 'active' : '' }}' href="{{ route('admin.restaurants.index') }}">Ristoranti</a>
                    </li>


                    <li class="nav-item">
                        <a class="nav-link text-white {{ str_contains(Route::currentRouteName(), 'admin.dishes.index') ? 'active' : '' }}" href="{{ route('admin.dishes.index') }}">Piatti</a>

                    </li>

                    <li class="nav-item">
                        <a class="nav-link text-white {{ str_contains(Route::currentRouteName(), 'admin.orders.index') ? 'active' : '' }}" href="{{ route('admin.orders.index') }}">Ordini</a>
