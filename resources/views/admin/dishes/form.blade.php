...
<section>
    <div class="container py-4">
       ...
       <a href="{{ route('admin.dishes.index') }}" class="btn btn-primary my-3">
               ...
               {{-- * Creation card --}}
                   <div class="card p-2">
                       ...
                       <div>
                           ...
                           id="name" name="name" type="text" max="150" required
                       ...
                       <div class="mt-2">
                           ...
                           id="price" name="price" type='number' step='0.01' min='0.01' max='9999' required
                       ...
                       <div class="mt-2">
                           ...
                           id="availability" name="availability" type="checkbox" value="1" 
                       ...
                       <div class="mt-2">
                           ...
                           >{{ empty($dish->id) ? '' : old('description') ?? $dish->description }}</textarea>
                           @error('description')
                           <div class="invalid-feedback">{{ $message }}</div>
                           @enderror
                       </div>
