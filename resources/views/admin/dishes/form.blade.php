        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="mt-2">
                    ...
                    <input step='0.01' min='0.01' max='9999' type='number' class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ empty($dish->id) ? '' : old('price') ?? $dish->price }}" required>
                ...
                <div class="mt-2">
                    ...
                    <input type="checkbox" class="form-check-input form-control" name="availability" id="availability" value="1" {{ $dish->availability ? 'checked' : '' }}>
                </div>
