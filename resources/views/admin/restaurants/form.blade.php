                    ...
                    <div class="col-sm-12 col-md-6 card p-3">
                        <div>
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name') ?? '' }}" required max='200' />
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" class="form-control @error('p_iva') is-invalid @enderror" id="p_iva"
                                name="p_iva" required pattern='\d{11}' title='11 cifre numeriche' />
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                name="phone" value="{{ old('phone') ?? '' }}" required max='20' />
