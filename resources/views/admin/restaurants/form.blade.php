            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-12 col-md-6 card p-3">
                    ...
                    <div>
                        ...
                        <input class="form-control @error('name') is-invalid @enderror" name="name" id="name" type="text" required max='200' value="{{ old('name') ?? '' }}" />
                        @error('name')
                    ...
                    <div class="mt-2">
                        ...
                        <input class="form-control @error('p_iva') is-invalid @enderror" name="p_iva" id="p_iva" type="text" required pattern='\d{11}' title='11 cifre numeriche' />
                        @error('p_iva')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mt-2">
                        ...
                        <input class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" type="text" required max='20' value="{{ old('phone') ?? '' }}" />
                        @error('phone')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mt-2">
                        ...
                        <input class="form-control @error('address') is-invalid @enderror" name="address" id="address" type="text" required max='150' />
                        @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
