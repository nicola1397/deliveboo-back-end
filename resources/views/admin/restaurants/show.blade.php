        ...
        <div class="row mb-5">
            ...
            <div class="col-sm-12 col-md-6 restaurantLayout  flex-column justify-content-center align-items-center">
                ...
                <div class="coverImage rounded-top mb-0 d-flex overflow-hidden">
                    <img src="{{ !empty($restaurant->image) ? asset('storage/' . $restaurant->image) : asset('storage/uploads/placeholder.png') }}" class="h-100 w-100 object-fit-cover">
                </div>
                ...
                <a href="{{ route('admin.dishes.show', $dish) }}">
                    <div class="d-flex mb-3">
                        ...
                        <div class="roundDish">
                            ...
                            <div class="dishPrev">
                                <img src="{{ !empty($dish->image) ? asset('storage/' . $dish->image) : asset('storage/uploads/placeholder.png') }}" alt="{{ $dish->name }}" class="">
                            </div>
